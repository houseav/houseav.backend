export const HouseInVerifyMailTemplate = (houseTitle: string): string => `
                        ...
                        <tbody>
                          <tr>
                            ...
                            >
                              ...
                              >
                                <div>
                                  <strong>Immobile Verificato! 🏠</strong>
                                  <br />
                                </div>
                              </h1>
                              <!--[if mso]>
                            ...
                            >
                              ...
                              >
                                ...
                                <p
                                  ...
                                  "
                                >
                                  Il tuo immobile <strong> ${houseTitle}</strong>, è stato creato con successo, attualmente è in fase di revisione da parte del nostro team.
                                  <br><br>
                                  Non appena sarà verificato, potrai visualizzarlo nel tuo profilo e tra i risultati di ricerca generali.</p>
                                <p
                                  style="
                                    font-size: 14px;
                                    line-height: 160%;
