export const UserVerifiedMailTemplate = (username: string): string => `
                        ...
                        <tbody>
                          <tr>
                            ...
                            >
                              ...
                              >
                                <div>
                                  <strong>Account Verificato 🔑</strong>
                                  <br />
                                </div>
                              </h1>
                              <!--[if mso]>
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <span
                                    style="
                                      ...
                                      line-height: 25.6px;
                                    "
                                    ><strong>Ciao ${username} 👋</strong></span
                                  >
                                </p>
                                <p
                                  style="
                                ...
                                <p
                                  ...
                                  "
                                >
                                  Il tuo account è stato verificato, effettua nuovamente l'accesso.<br>Ora puoi utilizzare tutte le funzionalità.</p>
                                <p
                                  style="
                                    font-size: 14px;
                                    line-height: 160%;
